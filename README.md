...
jobs:
    aspect-workflows:
        ...
        uses: my-org/workflows-action/.github/workflows/.aspect-workflows-reusable.yaml@5.13.0-alpha1.dev.41.g26e5ea9
```
...
jobs:
    delivery:
        ...
        steps:
            ...
            - name: Run delivery
              uses: aspect-build/workflows-action@5.13.0-alpha1.dev.41.g26e5ea9
              with:
                  task: delivery
